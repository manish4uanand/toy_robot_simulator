class Robot
  ...
  # Place method for placing the robot on the table in position X,Y and facing of robot will NORTH, SOUTH, EAST or WEST
  def place(x, y, direction)
    raise TypeError, 'Invalid origin' unless x.is_a? Integer and y.is_a? Integer
  ...
  # Move method is to move the robot one unit forward in the current facing direction
  def move
  ...
  # It returns X,Y and Direction of the robot
  def report
    return "Not on table" if @position.nil? or @direction.nil?
